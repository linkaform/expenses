...
#     return expense_obj.update_expense_catralog_values(current_record, SOL_DATA, total_gasto )
...
#     print('solicitud', SOL_DATA)
#     if expense_obj.SOL_DATA:
#         msg_error_app = {
...
if __name__ == '__main__':
    ...
    update_ok = expense_obj.update_expense_catralog_values(current_record, total_gasto=0, anticipo_efectivo=cash)
